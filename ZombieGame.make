...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/ZombieGame
OBJDIR = obj/x64/Debug/ZombieGame
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/ZombieGame
OBJDIR = obj/x86/Debug/ZombieGame
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/ZombieGame
OBJDIR = obj/ARM64/Debug/ZombieGame
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGET = $(TARGETDIR)/ZombieGame
OBJDIR = obj/x64/Release/ZombieGame
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/ZombieGame
OBJDIR = obj/x86/Release/ZombieGame
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/ZombieGame
OBJDIR = obj/ARM64/Release/ZombieGame
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
GENERATED += $(OBJDIR)/BulletPool.o
GENERATED += $(OBJDIR)/Enemy.o
GENERATED += $(OBJDIR)/Game.o
GENERATED += $(OBJDIR)/GameStates.o
...
$(OBJDIR)/BulletPool.o: src/BulletPool.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
...
$(OBJDIR)/Game.o: src/Game.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/GameStates.o: src/GameStates.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Player.o: src/Player.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/WaveManager.o: src/WaveManager.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
...
$(OBJDIR)/TimeBoostManager.o: src/TimeBoostManager.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Scoreboard.o: src/Scoreboard.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
